...
public class BasicAuthFilter extends OncePerRequestFilter {
    ...
    private Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (StringUtils.isEmpty(authorization) || !StringUtils.startsWithIgnoreCase(authorization, "basic")) {
            return null;
        } else {
            ...
            DialogflowAuthenticationToken authRequest = new DialogflowAuthenticationToken(values[0], values[1],
                    namespace);
